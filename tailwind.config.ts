...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        money: ["clamp(3rem, 12vw, 5rem)", { lineHeight: "1", letterSpacing: "-0.035em", fontWeight: "600" }],
        "title-1": ["1.75rem", { lineHeight: "1.1", letterSpacing: "-0.02em", fontWeight: "600" }],
        "title-2": ["1.25rem", { lineHeight: "1.2", letterSpacing: "-0.01em", fontWeight: "600" }],
